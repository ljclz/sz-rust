...
// ============================================================================
// Phase 7.6: 资源版本化（Cache-Control/ETag）
// ============================================================================
...
mod tests {
    ...
    // ====================================================================
    // Phase 7.5: MIME 类型表测试（对齐 PHP $mimeTypeMap）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.5: Range 头解析测试（对齐 Webman sendFile Range 分支）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.5: percent_decode 测试（对齐 PHP rawurldecode）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.5: serve_file 测试（对齐 PHP think-worker sendFile）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.5: serve_file Range 请求测试（对齐 Webman 206 Partial Content）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.5: static_handler 测试（对齐 PHP think-worker Http::sendFile 完整流程）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.5: 未知 MIME 类型 → Content-Disposition 测试（对齐 PHP think-worker）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.6: CacheControlConfig 测试（对齐 nginx expires 指令）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.6: compute_etag 测试（对齐 nginx 默认 ETag）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.6: fingerprint_bytes / fingerprint_file 测试
    ...
    // ====================================================================
    // Phase 7.6: extract_version_hash 测试
    //         （对齐前端构建工具文件名 hash 解析）
    // ====================================================================
    ...
    // ====================================================================
    // Phase 7.6: serve_file_with_cache 测试
    // ====================================================================
