...
fn is_sql_reserved_keyword(ident: &str) -> bool {
    matches!(
        ...
        "SELECT" | "FROM" | "WHERE" | "INSERT" | "UPDATE" | "DELETE" | "CREATE" | "DROP"
            | "TABLE" | "INDEX" | "VIEW" | "SEQUENCE" | "ORDER" | "GROUP" | "HAVING" | "LIMIT"
            | "OFFSET" | "JOIN" | "INNER" | "OUTER" | "LEFT" | "RIGHT" | "FULL" | "ON" | "AS"
            | "AND" | "OR" | "NOT" | "NULL" | "TRUE" | "FALSE" | "DEFAULT" | "PRIMARY" | "KEY"
            | "UNIQUE" | "FOREIGN" | "REFERENCES" | "CHECK" | "CONSTRAINT" | "BEGIN" | "COMMIT"
            | "ROLLBACK" | "SAVEPOINT" | "INTO" | "VALUES" | "SET" | "SHOW" | "EXPLAIN" | "WITH"
            | "UNION" | "INTERSECT" | "EXCEPT" | "DISTINCT" | "ALL" | "CASE" | "WHEN" | "THEN"
            | "ELSE" | "END" | "IF" | "EXISTS" | "BETWEEN" | "LIKE" | "ILIKE" | "IN" | "IS"
            | "CAST" | "ALTER" | "ADD" | "COLUMN" | "RENAME" | "TO" | "TRUNCATE" | "GRANT"
            | "REVOKE" | "PRIVILEGES" | "PUBLIC" | "USER" | "ROLE" | "SCHEMA" | "DATABASE"
            | "TYPE" | "FUNCTION" | "PROCEDURE" | "TRIGGER" | "RETURNING" | "CONFLICT"
            | "DO" | "NOTHING" | "REPLACE" | "IGNORE" | "TEMPORARY" | "TEMP" | "CASCADE"
